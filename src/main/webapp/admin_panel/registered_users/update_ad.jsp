						...
						<div class="card">
							...
							<div class="card-body">
								<form action="update_adDB.jsp" method="post"
									...
									while (rs.next()) {
									%>
									<input type="hidden" value="<%=rs.getString("id")%>" id="id"
										name="id">

									<div class="mb-3">
										<label for="title" class="form-label">Ad Title</label> <input
											type="text" class="form-control " id="title" name="title"
											placeholder="eg.Apple Iphone 11"
											value="<%=rs.getString("title")%>" required>
										<div class="invalid-feedback">Please provide a title for
											your ad.</div>
									</div>
									<div class="mb-3">
									...
									<div class="mb-3">
										...
										<div class="custom-file">
											<img src="assets/<%=rs.getString("image_path")%>"
												height="100" width="100"><br>
											<br> <input type="file"
												class="custom-file-input form-label" id="image" name="image"
